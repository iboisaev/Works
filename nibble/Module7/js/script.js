...
$(document).ready(function(){
    ...
    $('.info-single__title').on('click', function() {
        $(this).toggleClass('active');
        $(this).next().toggleClass('active');
    });
    $('.reviews').on('click', function() {
        $(this).toggleClass('active');
        $('.reviews-block').toggleClass('active');
    });
    $('.user-heart').on('click', function(){
        if($(this).attr('src') == 'img/heart-empty.svg'){
            $(this).attr('src', 'img/heart.svg');
        }else{
              $(this).attr('src', 'img/heart-empty.svg');
        }
    })
    // 
